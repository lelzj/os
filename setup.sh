...
# Check this block to see if any commands here exist in next block
...
efaults write com.apple.finder "FXPreferredViewStyle" -string "Nlsv" && killall Finder~
...
defaults write com.apple.screensaver askForPasswordDelay -int 
defaults write com.apple.screensaver askForPassword -int 1
